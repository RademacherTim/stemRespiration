...
If there is no problem, we want to save the plot and the fit to a data structure with the results. 

``` {r savePlotFit, echo = T}
fileName
nchar (fileName)
fileName2 <- (substr (fileName, nchar (fileName)-4, nchar (fileName)))
paste ('fig/',fileName2, sep = '')
#png (file = paste ('fig/',fileName,'2', sep = ''))
#plotResp (dat, 
#          resFlux = resFit,
#          colConc = 'CO2.dry',   # redundant
#          colTime = 'TIMESTAMP', # redundant
